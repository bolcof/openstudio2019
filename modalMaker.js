$(function(){
 	var info_M2 = [
 				["01_asao",		"高山明",	"浅尾 鷹哉",		"Takaya Asao",		"九州産業大学芸術学部デザイン学科卒",			""],
 				...
 				["13_li",		"高山明",	"李 和晋",		"Hwajin Lee",		"東京工芸大学芸術学部写真学科卒",				"https://hwajinleee.tumblr.com/"],
    ...
    //hukuhara
    ,"身近なものや出来事を主題、素材にして、映像や絵画、立体作品を制作しています。"
    ];
